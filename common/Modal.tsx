    ...
    return (
      <div>
        ...
        <motion.div
          ...
          animate={isOpen ? "open" : "closed"}
          className="fixed border-2 border-zinc-700 top-[0] left-[5vw] lg:left-[14vw] z-10 mx-auto mt-[20vh] w-[90%] lg:w-[70%] text-zinc-900 p-5 bg-zinc-50 dark:bg-zinc-900 dark:text-zinc-50 rounded-lg"
        >
          <div className="w-full pb-3 flex justify-between">
            <h1 className="text-[32px] font-bold">{title}</h1>
            <button id="closeModal" onClick={() => setIsOpen(false)} className="relative group left-7 w-[2rem] h-[2rem] rounded-full group-hover:bg-zinc-200 group-hover:dark:bg-zinc-600 transition-all duration-200">
