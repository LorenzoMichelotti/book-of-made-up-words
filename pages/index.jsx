  ...
  return (
    <div className="w-full">
      <div className="mx-auto w-[90%] mt-12">
        ...
        pageLinkClassName="bg-slate-800 font-bold p-2 px-3 rounded-lg text-center"
        previousLinkClassName="bg-slate-800 font-bold p-2 px-3 rounded-lg text-center"
        nextLinkClassName="bg-slate-800 font-bold p-2 px-3 rounded-lg text-center"
        activeLinkClassName="bg-slate-700 font-bold text-blue-500 p-2 px-3 rounded-lg text-center"
        />
